...
CREATE TABLE Avion (id SERIAL NOT NULL, nom varchar(50) NOT NULL UNIQUE, photo text, longueur float8 NOT NULL, hauteur float8 NOT NULL, Constructeurid int4 NOT NULL, PRIMARY KEY (id));
...
INSERT INTO Avion(id, nom, photo, longueur, hauteur, Constructeurid) VALUES (1, 'Atlas', 'http://localhost:8080/images/atlas.jpg', 37.57, 11.76 , 1);
INSERT INTO Avion(id, nom, photo, longueur, hauteur, Constructeurid) VALUES (2, 'Cotam Unite', 'http://localhost:8080/images/unite.jpg', 40, 12, 1);
INSERT INTO Avion(id, nom, photo, longueur, hauteur, Constructeurid) VALUES (3, 'Ocean Sentry', 'http://localhost:8080/images/ocean.jpg', 32, 10, 1);
INSERT INTO Avion(id, nom, photo, longueur, hauteur, Constructeurid) VALUES (4, 'Bird of Prey', 'http://localhost:8080/images/bird.jpg', 40, 13, 2);
INSERT INTO Avion(id, nom, photo, longueur, hauteur, Constructeurid) VALUES (5, 'Blackjack', 'http://localhost:8080/images/bird.jpg', 35, 11, 2);
INSERT INTO Avion(id, nom, photo, longueur, hauteur, Constructeurid) VALUES (6, 'Antey', 'http://localhost:8080/images/antey.jpg', 31, 14, 3);
INSERT INTO Avion(id, nom, photo, longueur, hauteur, Constructeurid) VALUES (7, 'Mriya', 'http://localhost:8080/images/mriya.jpg', 29, 10, 3);
